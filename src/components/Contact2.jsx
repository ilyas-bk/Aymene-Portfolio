        ...
        <div className="lg:w-3/6  w-full h-full flex flex-col justify-between">
          <div className="  w-full xl:py-12 py-4 flex flex-col justify-center items-center ">
            <h2
              ...
              className="text-white 2xl:text-[11rem] lg:text-[6rem] md:text-[5rem] text-[4rem] text-center"
            >
              Let's Work <span className="2xl:text-[14rem] lg:text-[7rem] md:text-[6rem] text-[5rem]">Together!</span>
            </h2>
          </div>
